...
return [
    ...
    |            "database", "collection", "tntsearch", "null"
    |
    */
    ...
    */
    ...
    |----------------------------------------------------------------------
    |
    | TNTSearch is used for local development. In production, set
    | SCOUT_DRIVER=meilisearch and configure the Meilisearch variables.
    |
    */

    'tntsearch' => [
        'storage' => storage_path('framework/scout'),
