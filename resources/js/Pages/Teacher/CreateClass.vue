...
const blurStudents    = () => { fieldErrors.value.max_students = validateNumberRange(form.value.max_students, 2, 30, 'Max students').error || ''; };
        ...
        <div style="max-width: 700px; margin: 0 auto; padding: 48px 24px;">
            ...
            <div v-else>
                ...
                <div style="margin-bottom:32px;">
                    ...
                    <input id="cc-max" v-model.number="form.max_students" type="number" min="2" max="30"
