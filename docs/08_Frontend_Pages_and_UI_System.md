...
Used in chat/collaboration areas:

- typing indicators
- message push updates
- presence/participant indicators
- collaborative session signals (draw/whiteboard related events)
...
## Frontend Build and Dev Workflow

- install packages: `npm install`
- dev server: `npm run dev`
- production build: `npm run build`

Important: if Blade pages fail due to Vite manifest keys, rebuild assets and confirm manifest contains required entries.
